...
echo "\n\nPartition:" ${partition} "Number of core:" ${Ncore} "Spin:"${Spin} ";L:" ${L1} "~" ${L2} "(" ${space_L} ")" ";J:" ${J1} "~" ${J2} "(" ${space_J} ")" ";D:" ${D1} "~" ${D2} "(" ${space_D} ")" ",seed1:" ${s1} ",seed2:" ${s2} "Orderparameter:" ${orderparameter}";BC="${BC}";B="${bonDim}

echo -e "\n\nPartition:" ${partition} "Number of core:" ${Ncore} "Spin:${Spin}" ";L:" ${L1} "~" ${L2} "(" ${space_L} ")" ";J:" ${J1} "~" ${J2} "(" ${space_J} ")" ";D:" ${D1} "~" ${D2} "(" ${space_D} ")" ",seed1:" ${s1} ",seed2:" ${s2} "Orderparameter:" ${orderparameter}";BC="$BC";B="${bonDim} >> "${file}.txt"
